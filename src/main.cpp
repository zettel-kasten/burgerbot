...
{
    const int nTargetSpacing = 60; // BurgerBot: 1 minute
    const int nTargetTimespan = 6*60*60; // BurgerBot: 6 hours
...
{
    const char* pszTimestamp = "BurgerHash Test 1";
