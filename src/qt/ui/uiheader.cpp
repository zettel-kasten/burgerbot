...
void UIHeader::paintEvent(QPaintEvent *e)
{
    ...
    QPixmap pix_logo_testnet(":/icons/testnet");

    painter.drawPixmap(140,12,pix_logo_testnet);
    ...
    painter.setPen(QColor("#BF8F00"));
    stat_ZTTL.setText("BURGER");
